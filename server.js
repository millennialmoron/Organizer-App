...
async function main() {
  ...
  app.get("/static/js/main.6679c643.js", function (req, res) {
    res.sendFile(path.join(__dirname, "build", "static/js/main.6679c643.js"));
  });
  ...
  app.get("/views/privacy.html", function (req, res) {
